...
Esta experimentacion consiste en probar la creacion de modelos mediante las tecnicas OIL y HMM utilizando 
...
CleavageSites/
  contains the cleavage site annotation manually done using ProteinTagger (https://code.google.com/p/protein-tagger/)
